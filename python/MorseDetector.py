...
class blk(gr.sync_block):
    ...
    def __init__(self, OOK_pause=270, ASCII_pause=825, short_sym=280,
                 long_sym=870, break_pause=1200, tolerance=40,
                 print_symbols=True, print_1duration=False,
